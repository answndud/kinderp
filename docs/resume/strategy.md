...
| role/tenant 권한 경계 | 보안 감각, 요구사항 분해, 검증 책임 | [`../../src/main/java/com/erp/global/security/access`](../../src/main/java/com/erp/global/security/access), [`../../src/test/java/com/erp/api`](../../src/test/java/com/erp/api) |
| Cookie JWT + Redis refresh/session registry | 인증/세션 설계, 운영상 revoke 요구 반영 | [`../../src/main/java/com/erp/global/security/jwt`](../../src/main/java/com/erp/global/security/jwt), [`../../src/main/java/com/erp/domain/auth`](../../src/main/java/com/erp/domain/auth) |
| 입학 신청 review workflow 분리 | 상태 전이와 side effect를 분리하는 설계 | [`../../src/main/java/com/erp/domain/kidapplication/service`](../../src/main/java/com/erp/domain/kidapplication/service), [`../../src/test/java/com/erp/api/KidApplicationApiIntegrationTest.java`](../../src/test/java/com/erp/api/KidApplicationApiIntegrationTest.java) |
| Notification outbox timeline/dead-letter/retry | 외부 시스템 실패를 운영 가능한 흐름으로 설계 | [`../../src/main/java/com/erp/domain/notification`](../../src/main/java/com/erp/domain/notification), [`../../src/test/java/com/erp/api/NotificationOutboxOpsApiIntegrationTest.java`](../../src/test/java/com/erp/api/NotificationOutboxOpsApiIntegrationTest.java) |
| Audit log 필터/export | 장애/문의 대응을 위한 운영 조사 가능성 | [`../../src/main/java/com/erp/domain/authaudit`](../../src/main/java/com/erp/domain/authaudit), [`../../src/main/java/com/erp/domain/domainaudit`](../../src/main/java/com/erp/domain/domainaudit) |
| 성능 개선 수치 | "개선했다"를 숫자로 검증 | Notepad `22 -> 5` queries, Dashboard cache hit `5 -> 0` queries, [`../../src/test/java/com/erp/performance`](../../src/test/java/com/erp/performance) |
...
| Production-like safety | 실제 배포 전 리스크를 fail-closed로 차단 | [`../guides/production-like-checklist.md`](../guides/production-like-checklist.md), [`../../src/main/java/com/erp/global/config`](../../src/main/java/com/erp/global/config), [`../../deploy`](../../deploy) |
