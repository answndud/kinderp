...
- 보안: `src/main/java/com/kinderp/global/security/`
- 접근 정책: `src/main/java/com/kinderp/global/security/access/AccessPolicyService.java`
- JWT: `src/main/java/com/kinderp/global/security/jwt/`
- Outbox: `src/main/java/com/kinderp/domain/notification/`
- 시간: `src/main/java/com/kinderp/global/common/ProductTime.java`
- 계층 테스트: `src/test/java/com/kinderp/architecture/LayerDependencyTest.java`
