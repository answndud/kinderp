...
required="APP_DOMAIN APP_IMAGE APP_VERSION MYSQL_ROOT_PASSWORD MYSQL_DATABASE MYSQL_USER MYSQL_PASSWORD REDIS_PASSWORD CORS_ALLOWED_ORIGINS JWT_SECRET NOTIFICATION_EMAIL_ENABLED NOTIFICATION_EMAIL_FROM SPRING_MAIL_HOST SPRING_MAIL_USERNAME SPRING_MAIL_PASSWORD"
